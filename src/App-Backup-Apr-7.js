...
function App() {
  ...
  const [macbookOverlayVisible, setMacbookOverlayVisible] = useState(false);
  ...
  useOnClickOutside(modal, () => closeOverlay());
  ...
  const macbookClick = () => {
    if (windowWidth.width >= 768) {
      setMacbookOverlayVisible(true);
      document.querySelector("html, body, div.app").classList.add("fixed");
    }
  }
  
  const closeOverlay = () => {
    setMacbookOverlayVisible(false);
    document.querySelector("html, body, div.app").classList.remove("fixed");
  }
  

  const MacbookOverlay = () => (
    <div className="mackbookOverlay">
      <button className="mackbookOverlay__close" onClick={()=> closeOverlay()}><TfiClose /></button>
      <div className={indochinoVisible ? "macbook indochino" : "macbook"} ref={modal}>
        <div className="macbookPageBg">
          {kitandaceVisible ? <div className="macbookSliderWrapper"><MacbookSlider1 /></div> : null}
          {indochinoVisible ? <img src={IndochinoSlide} className="sliding" alt="Indochino Gallery" /> : null}
          {openroadVisible ? <div className="macbookSliderWrapper"><MacbookSlider2 /></div> : null}
        </div>
      </div>
    </div>
  )
    ...
    <div className="App">
        <header>
          <div ref={node} className="navigation">
            <Burger open={open} setOpen={setOpen} onClick={() => console.log("click")}/>
            <Menu
              open={open}
              setOpen={setOpen}
          ...
          <div className="section__innerWrapper">
            <div className="section__content__left">
              <div className="section__content__left__innerWrapper">
                ...
                <p>I'm a front-end web developer based in Nelson, BC Canada.</p>
                <p>I specialize in custom, large-scale enterprise Web Applications while at the same time looking to throw a bit of fun into the mix.</p>
                <p>If you are interested in reaching out, please <button className="link welcome" onClick={() => scrollDown(section7)}>contact me</button>.</p>
                <br/>
        ...
        <section ref={section3} id="section3" className="section experience">
          <div className="section__innerWrapper">
            ...
            <animated.div className="kitAndAceSlideWrapper" style={webWorkStyle}>
              ...
              ?
                <animated.div className="kitAndAce" style={style}>
                  ...
                  <div className="experience__copy">
                    ...
                    <p>Web/UX Designer<br/>Junior Front-End Developer</p>
        ...
        <section ref={section4} id="section4" className="section graphicDesign">
          <div className="section__innerWrapper">
            <div className="section__content__left">
              <GraphicSlider />
            </div>
        ...
        <section ref={section5} id="section5" className="section things">
          <div className="section__innerWrapper">
        ...
        <section ref={section6} id="section6" className="section about">
          <div className="section__innerWrapper">
            <div className="section__content__left">
        ...
        <section ref={section7} id="section7" className="section contact">
          <div className="section__innerWrapper">
              <div className="section__content__left">
        ...
        {macbookOverlayVisible && <MacbookOverlay />}
        {open && <MenuOverlay />}
    </div>
  );
}
